:root {
  ...
  --h1-font: '<?php the_field( 'h1_font', 'option' ) ?>', sans-serif;
  ...
  --h1-size-d: <?php the_field( 'h1_font_size_desktop', 'option' ) ?>px;
  --h1-size-m: <?php the_field( 'h1_font_size_mobile', 'option' ) ?>px;

  --h2-font: '<?php the_field( 'h2_font', 'option' ) ?>', sans-serif;
  ...
  --h2-size-d: <?php the_field( 'h2_font_size_desktop', 'option' ) ?>px;
  --h2-size-m: <?php the_field( 'h2_font_size_mobile', 'option' ) ?>px;

  --h3-font: '<?php the_field( 'h3_font', 'option' ) ?>', sans-serif;
  ...
  --h3-size-d: <?php the_field( 'h3_font_size_desktop', 'option' ) ?>px;
  --h3-size-m: <?php the_field( 'h3_font_size_mobile', 'option' ) ?>px;

  --h4-font: '<?php the_field( 'h4_font', 'option' ) ?>', sans-serif;
  --h4-weight: <?php the_field('h4_font_weight', 'option' ) ?>;
  --h4-colour: <?php the_field( 'h4_colour', 'option' ) ?>;
  --h4-style: <?php the_field( 'h4', 'option' ) ?>;
  --h4-size-d: <?php the_field( 'h4_font_size_desktop', 'option' ) ?>px;
  --h4-size-m: <?php the_field( 'h4_font_size_mobile', 'option' ) ?>px;

  --h5-font: '<?php the_field( 'h5_font', 'option' ) ?>', sans-serif;
  ...
  --h5-size-d: <?php the_field( 'h5_font_size_desktop', 'option' ) ?>px;
  --h5-size-m: <?php the_field( 'h5_font_size_mobile', 'option' ) ?>px;

  --h6-font: '<?php the_field( 'h6_font', 'option' ) ?>', sans-serif;
  ...
  --h6-size-d: <?php the_field( 'h6_font_size_desktop', 'option' ) ?>px;
  --h6-size-m: <?php the_field( 'h6_font_size_mobile', 'option' ) ?>px;
